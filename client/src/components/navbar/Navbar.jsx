    ...
    <section className={styles.container}>
      <div className={styles.navBox}>
        <div className={styles.topNavBox}>
          <span className={styles.moreOpt} onClick={handleNavOpen}><i class="fas fa-bars"></i></span>
        ...
        <div className={navOpen? styles.category: styles.categoryClose}>
          <ul className={styles.categoryBox}>
            <li className={styles.title} onClick={handleNavClose}>ABOUT</li>
            <Link to='/gallery'>
              <li className={styles.title} onClick={handleNavClose}>GALLERY</li>
            </Link>
            <Link to='/reviewlist'>
              <li className={styles.title} onClick={handleNavClose}>REVIEW</li>
            </Link>
            <Link to='/register'>
              <li className={styles.title} onClick={handleNavClose}>REGISTER</li>
            </Link>
            <Link to='/auction'>
