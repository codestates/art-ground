...
const GalleryContent = ({
  ...
  if (isLogin) {
    // 로그인했다면? 좋아요를 했는지 안했는지에 따라서 하트 다르게 랜더링. 좋아요 클릭시 좋아요/좋아요 해제 가능
    return (
      <>
        <li className={styles.object}>
          <Link to="/gallerydetail">
            ...
            <img
              ...
              src="http://www.news-paper.co.kr/news/photo/201903/39919_25361_5530.jpg"
              alt="thumbnail"
            />
          </Link>
    ...
    // 로그인 안 했다면? 좋아요 default 회색하트 랜더링. 클릭 시 로그인해주세요 모달창 띄우기
    return (
      <li className={styles.object}>
        <Link to="/gallerydetail">
          <div
